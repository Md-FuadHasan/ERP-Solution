...
export interface Product {
  ...
  unitType: ProductUnitType;      // Base unit for stockLevel and primary pricing (basePrice, exciseTax).
...
furtherExpiryDate.setDate(todayForMock.getDate() + 75); // Approx 75 days from now


export const MOCK_PRODUCTS: Product[] = [
  { id: 'PROD001', name: 'Ice Cream Cone - Blueberry 80ml', sku: 'ICCBLUE80', category: 'Frozen', unitType: 'Cartons', piecesInBaseUnit: 24, basePrice: 18.00, costPrice: 12.00, exciseTax: 1.20, batchNo: 'B001A', productionDate: '2024-01-01', expiryDate: nearExpiryDate.toISOString(), discountRate: 0, createdAt: new Date().toISOString(), globalReorderPoint: 10 },
  { id: 'PROD002', name: 'LABAN - 900 ML (Bottle)', sku: 'LBN90020', category: 'Dairy', unitType: 'PCS', piecesInBaseUnit: 1, basePrice: 1.00, costPrice: 0.60, exciseTax: 0.10, discountRate: 5, createdAt: new Date().toISOString(), expiryDate: furtherExpiryDate.toISOString(), globalReorderPoint: 240 },
  ...
  { id: 'PROD004', name: 'Al Rabie Juice 125ml - Orange', sku: '25027-ORG', category: 'Beverages', unitType: 'PCS', piecesInBaseUnit: 1, packagingUnit: 'Carton', itemsPerPackagingUnit: 18, basePrice: 0.60, costPrice: 0.35, exciseTax: 0.02, createdAt: new Date().toISOString(), expiryDate: new Date(new Date().setDate(new Date().getDate() + 60)).toISOString(), globalReorderPoint: 50 }, // 50 * 18 = 900 PCS
  { id: 'PROD005', name: 'Ice Cream Tub 1.8L - Vanilla', sku: '80012-VAN', category: 'Frozen', unitType: 'PCS', piecesInBaseUnit: 1, packagingUnit: 'Carton', itemsPerPackagingUnit: 6, basePrice: 2.50, costPrice: 1.50, exciseTax: 0.50, createdAt: new Date().toISOString(), expiryDate: '2024-11-30', globalReorderPoint: 20 }, // 20 * 6 = 120 PCS
  { id: 'PROD006', name: 'UHT Milk 200ml', sku: '59012', category: 'Dairy', unitType: 'PCS', piecesInBaseUnit: 1, packagingUnit: 'Carton', itemsPerPackagingUnit: 18, basePrice: 0.75, costPrice: 0.40, exciseTax: 0, createdAt: new Date().toISOString(), expiryDate: '2024-10-15', globalReorderPoint: 60 }, // 60 * 18 = 1080 PCS
  ...
  { id: 'PROD008', name: 'Ice Cream Cone 120ml - Vanilla/Strawberry', sku: '12024-VS', category: 'Frozen', unitType: 'Cartons', piecesInBaseUnit: 24, basePrice: 18.80, costPrice: 13.20, exciseTax: 0.72, createdAt: new Date().toISOString(), expiryDate: '2024-09-30', globalReorderPoint: 2 }, // low
...
export const MOCK_PRODUCT_STOCK_LOCATIONS: ProductStockLocation[] = [
  // PROD001 (Blueberry Ice Cream Cone - Base Unit: Cartons, piecesInBaseUnit: 24)
  { id: 'PSL001', productId: 'PROD001', warehouseId: 'WH-PROD-ICE', stockLevel: 50, reorderPoint: 5 }, // 50 Cartons
  { id: 'PSL002', productId: 'PROD001', warehouseId: 'WH-JED-01', stockLevel: 20, reorderPoint: 2 },   // 20 Cartons
  { id: 'PSL003', productId: 'PROD001', warehouseId: 'WH-RIY-01', stockLevel: 1, reorderPoint: 1 },    // 1 Carton (Low Stock relative to globalReorderPoint)

  // PROD002 (Laban 900ml - Base Unit: PCS)
  { id: 'PSL004', productId: 'PROD002', warehouseId: 'WH-PROD-LABAN', stockLevel: 1000, reorderPoint: 100 },
  { id: 'PSL005', productId: 'PROD002', warehouseId: 'WH-JED-01', stockLevel: 120, reorderPoint: 24 }, // Low stock relative to globalReorderPoint (240)

  // PROD004 (Al Rabie Juice - Base Unit: PCS, packagingUnit: Carton, itemsPerPackagingUnit: 18)
  { id: 'PSL006', productId: 'PROD004', warehouseId: 'WH-PROD-TETRA', stockLevel: 2000, reorderPoint: 200 }, // approx 111 Cartons
  ...
  // PROD005 (Vanilla Ice Cream Tub - Base Unit: PCS, packagingUnit: Carton, itemsPerPackagingUnit: 6)
  { id: 'PSL009', productId: 'PROD005', warehouseId: 'WH-PROD-ICE', stockLevel: 100, reorderPoint: 20 }, // approx 16 Cartons
  { id: 'PSL010', productId: 'PROD005', warehouseId: 'WH-JED-01', stockLevel: 5, reorderPoint: 6 }, // Low Stock

  // PROD009 (Sugar - Base Unit: Kgs)
  { id: 'PSL011', productId: 'PROD009', warehouseId: 'WH-PROD-ICE', stockLevel: 500, reorderPoint: 100 },
  { id: 'PSL012', productId: 'PROD009', warehouseId: 'WH-PROD-TETRA', stockLevel: 300, reorderPoint: 50 },

  // PROD008 (Vanilla/Strawberry Ice Cream Cone - Base Unit: Cartons, piecesInBaseUnit: 24)
  { id: 'PSL013', productId: 'PROD008', warehouseId: 'WH-PROD-ICE', stockLevel: 1, reorderPoint: 1 }, // 1 carton (Low stock compared to product's globalReorderPoint: 2)
];
...
const mockInvoiceItems1: InvoiceItem[] = [
  // product.basePrice + product.exciseTax
  { id: 'item1-inv1', productId: 'PROD001', description: 'Ice Cream Cone - Blueberry 80ml', quantity: 2, unitPrice: (18.00 + 1.20), total: (18.00 + 1.20) * 2, unitType: 'Cartons' }
];
const totals1 = {
  subtotal: mockInvoiceItems1.reduce((sum, item) => sum + item.total, 0),
  taxAmount: 0, // General tax is 0
  vatAmount: mockInvoiceItems1.reduce((sum, item) => sum + item.total, 0) * (MOCK_COMPANY_PROFILE.vatRate as number / 100),
  get totalAmount() { return this.subtotal + this.taxAmount + this.vatAmount; }
};


const mockInvoiceItems2: InvoiceItem[] = [
  { id: 'item1-inv2', productId: 'PROD002', description: 'LABAN - 900 ML (Bottle)', quantity: 12, unitPrice: (1.00 + 0.10), total: (1.00 + 0.10) * 12, unitType: 'PCS' }
];
const totals2 = {
  subtotal: mockInvoiceItems2.reduce((sum, item) => sum + item.total, 0),
  taxAmount: 0,
  vatAmount: mockInvoiceItems2.reduce((sum, item) => sum + item.total, 0) * (MOCK_COMPANY_PROFILE.vatRate as number / 100),
  get totalAmount() { return this.subtotal + this.taxAmount + this.vatAmount; }
};

const mockInvoiceItems3: InvoiceItem[] = [
  { id: 'item1-inv3', productId: 'PROD003', description: 'Cooking Cream 1080ml', quantity: 5, unitPrice: (13.20 + 0), total: (13.20 + 0) * 5, unitType: 'Cartons' }
];
const totals3 = {
  subtotal: mockInvoiceItems3.reduce((sum, item) => sum + item.total, 0),
  taxAmount: 0,
  vatAmount: mockInvoiceItems3.reduce((sum, item) => sum + item.total, 0) * (MOCK_COMPANY_PROFILE.vatRate as number / 100),
  get totalAmount() { return this.subtotal + this.taxAmount + this.vatAmount; }
};

const mockInvoiceItems4: InvoiceItem[] = [
  { id: 'item1-inv4', productId: 'PROD004', description: 'Al Rabie Juice 125ml - Orange', quantity: 18, unitPrice: (0.60 + 0.02), total: (0.60 + 0.02) * 18, unitType: 'PCS' } // 1 carton
];
const totals4 = {
  subtotal: mockInvoiceItems4.reduce((sum, item) => sum + item.total, 0),
  taxAmount: 0,
  vatAmount: mockInvoiceItems4.reduce((sum, item) => sum + item.total, 0) * (MOCK_COMPANY_PROFILE.vatRate as number / 100),
  get totalAmount() { return this.subtotal + this.taxAmount + this.vatAmount; }
};
